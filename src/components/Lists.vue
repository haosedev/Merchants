        ...
        <card :header="{title:'我的收入'}">
            <div slot="content" class="box-flex box-content">
                <div class="vux-1px-l vux-1px-r">
                    <div class="span">￥
                        <countup :end-val="info.price0" :duration="2" :decimals="2" class="demo1"></countup>
                    </div>
                    <div class="income cash">现金收入</div>
                </div>
                <div>
                    <div class="span">￥
                        <countup :end-val="info.price1" :duration="2" :decimals="2" class="demo1"></countup>
                    </div>
            ...
            <div slot="content" class="box-flex box-content top-hr">
                <div class="vux-1px-l vux-1px-r">
                    <div class="span">￥
                        <countup :end-val="info.price2" :duration="2" :decimals="2" class="demo1"></countup>
                    </div>
                    <div class="income alipay">支付宝码</div>
                </div>
                <div>
                    <div class="span">￥
                        <countup :end-val="info.price3" :duration="2" :decimals="2" class="demo1"></countup>
                    </div>
    ...
    export default {
            ...
            getList() {
                ...
                this.$http.post('http://mc.httpcenter.com/Vue/Sell/slist', param)
                    .then(res => {
                        ...
                        //总额
                        if (total) {
                            this.info.price0 = parseFloat(total[0].price);
                            this.info.price1 = parseFloat(total[1].price);
                            this.info.price2 = parseFloat(total[2].price);
                            this.info.price3 = parseFloat(total[3].price);
                        } else {
        ...
        data() {
            return {
                ...
                info_bak: { price0: 0, price1: 0, price2: 0, price3: 0, },
                info: { price0: 0, price1: 0, price2: 0, price3: 0, },
                orderList: [{
                    sn: '100000011111',
                    type_c: '现金',
                    total_fee: '10.00',
